...
func (a *App) initGRPCServer(ctx context.Context) error {
	...
	chat_api.RegisterChatApiServer(a.grpcServer, a.serviceProvider.ChatImpl(ctx))
	chat_api.RegisterChatApiServer(a.grpcServer, a.serviceProvider.MessageImpl(ctx))
